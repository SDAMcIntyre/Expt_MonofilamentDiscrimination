...
displayText = {'waitMessage':'Please wait.',
                ...
                'painQuestion':'Which was most painful, 1st or 2nd?',
...
exptInfo = {'01. Participant Code':'test', 
            '02. Standard monofilaments':'5', 
            '03. Comparison monofilaments':'1,3,5,7,9',
            '04. Number of repeats (even)':20, 
            '05. Folder for saving data':'data',
            '06. Participant screen':1,
            '07. Participant screen resolution':'1280,720',
            '08. Experimenter screen':0,
            '09. Experimenter screen resolution':'800,600'}
...
participantWin = visual.Window(fullscr = True, 
                            allowGUI = False, 
